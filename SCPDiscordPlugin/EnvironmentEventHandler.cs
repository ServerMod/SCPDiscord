...
namespace SCPDiscord
{
    class EnvironmentEventHandler : IEventHandlerSCP914Activate, IEventHandlerWarheadStartCountdown, IEventHandlerWarheadStopCountdown, IEventHandlerWarheadDetonate, IEventHandlerLCZDecontaminate
    {
        ...
        public void OnSCP914Activate(SCP914ActivateEvent ev)
        {
            ...
            /// </summary> 
            plugin.SendMessageAsync(plugin.GetConfigString("discord_channel_onscp914activate"), plugin.MultiLanguage(39) + " " + ev.KnobSetting + ".");
        }
        ...
        public void OnStartCountdown(WarheadStartEvent ev)
        {
            ...
            /// </summary> 
            plugin.SendMessageAsync(plugin.GetConfigString("discord_channel_onstartcountdown"), plugin.MultiLanguage(40));
        }
        ...
        public void OnStopCountdown(WarheadStopEvent ev)
        {
            ...
            /// </summary> 
            plugin.SendMessageAsync(plugin.GetConfigString("discord_channel_onstopcountdown"), plugin.MultiLanguage(41));
        }
        ...
        public void OnDetonate()
        {
            ...
            /// </summary> 
            plugin.SendMessageAsync(plugin.GetConfigString("discord_channel_ondetonate"), plugin.MultiLanguage(42));
        }
        ...
        public void OnDecontaminate()
        {
            ...
            /// </summary> 
            plugin.SendMessageAsync(plugin.GetConfigString("discord_channel_ondecontaminate"), plugin.MultiLanguage(43));
        }
    }
}
