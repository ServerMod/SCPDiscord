...
namespace SCPDiscord
{
    ...
    class AdminEventListener : IEventHandlerAdminQuery, IEventHandlerAuthCheck, IEventHandlerBan
    {
        ...
        public void OnAdminQuery(AdminQueryEvent ev)
        {
            ...
            plugin.SendDiscordMessage(plugin.GetConfigString("discord_channel_onadminquery"), "admin.onadminquery", variables);
        }
        ...
        public void OnAuthCheck(AuthCheckEvent ev)
        {
            ...
            plugin.SendDiscordMessage(plugin.GetConfigString("discord_channel_onauthcheck"), "admin.onauthcheck", variables);
        }
        ...
        public void OnBan(BanEvent ev)
        {
            ...
            plugin.SendDiscordMessage(plugin.GetConfigString("discord_channel_onban"), "admin.onban", variables);
        }
    }
}
