        ...
        IEventHandler106CreatePortal, IEventHandler106Teleport, IEventHandlerElevatorUse, IEventHandlerHandcuffed , IEventHandlerPlayerTriggerTesla, IEventHandlerSCP914ChangeKnob
    {
        ...
        public void OnPlayerHurt(PlayerHurtEvent ev)
        {
            ...
            if (ev.Attacker == null || ev.Player.PlayerId == ev.Attacker.PlayerId)
            {
                ...
                plugin.SendMessageToBot(Config.GetArray("channels.onplayerhurt"), "player.onplayerhurt.noattacker", noAttackerVar);
                return;
            }
            ...
            {
                plugin.SendMessageToBot(Config.GetArray("channels.onplayerhurt"), "player.onplayerhurt.friendlyfire", variables);
                return;
            }

            plugin.SendMessageToBot(Config.GetArray("channels.onplayerhurt"), "player.onplayerhurt", variables);
        }
        ...
        public void OnPlayerDie(PlayerDeathEvent ev)
        {
            ...
            if (ev.Killer == null || ev.Player.PlayerId == ev.Killer.PlayerId)
            {
                ...
                plugin.SendMessageToBot(Config.GetArray("channels.onplayerdie"), "player.onplayerdie.nokiller", noKillerVar);
                return;
            }
            ...
            {
                plugin.SendMessageToBot(Config.GetArray("channels.onplayerdie"), "player.onplayerdie.friendlyfire", variables);
                return;
            }
            plugin.SendMessageToBot(Config.GetArray("channels.onplayerdie"), "player.onplayerdie", variables);
        }
        ...
        public void OnPlayerPickupItem(PlayerPickupItemEvent ev)
        {
            ...
            plugin.SendMessageToBot(Config.GetArray("channels.onplayerpickupitem"), "player.onplayerpickupitem", variables);
        }
        ...
        public void OnPlayerDropItem(PlayerDropItemEvent ev)
        {
            ...
            plugin.SendMessageToBot(Config.GetArray("channels.onplayerdropitem"), "player.onplayerdropitem", variables);
        }
        ...
        public void OnPlayerJoin(PlayerJoinEvent ev)
        {
            ...
            plugin.SendMessageToBot(Config.GetArray("channels.onplayerjoin"), "player.onplayerjoin", variables);
        }
        ...
        public void OnNicknameSet(PlayerNicknameSetEvent ev)
        {
            ...
            plugin.SendMessageToBot(Config.GetArray("channels.onnicknameset"), "player.onnicknameset", variables);
        }
        ...
        public void OnAssignTeam(PlayerInitialAssignTeamEvent ev)
        {
            ...
            plugin.SendMessageToBot(Config.GetArray("channels.onassignteam"), "player.onassignteam", variables);
        }
        ...
        public void OnSetRole(PlayerSetRoleEvent ev)
        {
            ...
            plugin.SendMessageToBot(Config.GetArray("channels.onsetrole"), "player.onsetrole", variables);
        }
        ...
        public void OnCheckEscape(PlayerCheckEscapeEvent ev)
        {
            ...
            if(ev.AllowEscape)
            {
                plugin.SendMessageToBot(Config.GetArray("channels.oncheckescape"), "player.oncheckescape", variables);
            }
            else
            {
                plugin.SendMessageToBot(Config.GetArray("channels.oncheckescape"), "player.oncheckescape.denied", variables);
            }
        }
        ...
        public void OnSpawn(PlayerSpawnEvent ev)
        {
            ...
            plugin.SendMessageToBot(Config.GetArray("channels.onspawn"), "player.onspawn", variables);
        }
        ...
        public void OnDoorAccess(PlayerDoorAccessEvent ev)
        {
            ...
            if (ev.Allow)
            {
                plugin.SendMessageToBot(Config.GetArray("channels.ondooraccess"), "player.ondooraccess", variables);
            }
            else
            {
                plugin.SendMessageToBot(Config.GetArray("channels.ondooraccess"), "player.ondooraccess.notallowed", variables);
            }
        }
        ...
        public void OnIntercom(PlayerIntercomEvent ev)
        {
            ...
            plugin.SendMessageToBot(Config.GetArray("channels.onintercom"), "player.onintercom", variables);
        }
        ...
        public void OnIntercomCooldownCheck(PlayerIntercomCooldownCheckEvent ev)
        {
            ...
            plugin.SendMessageToBot(Config.GetArray("channels.onintercomcooldowncheck"), "player.onintercomcooldowncheck", variables);
        }
        ...
        public void OnPocketDimensionExit(PlayerPocketDimensionExitEvent ev)
        {
            ...
            plugin.SendMessageToBot(Config.GetArray("channels.onpocketdimensionexit"), "player.onpocketdimensionexit", variables);
        }
        ...
        public void OnPocketDimensionEnter(PlayerPocketDimensionEnterEvent ev)
        {
            ...
            plugin.SendMessageToBot(Config.GetArray("channels.onpocketdimensionenter"), "player.onpocketdimensionenter", variables);
        }
        ...
        public void OnPocketDimensionDie(PlayerPocketDimensionDieEvent ev)
        {
            ...
            plugin.SendMessageToBot(Config.GetArray("channels.onpocketdimensiondie"), "player.onpocketdimensiondie", variables);
        }
        ...
        public void OnThrowGrenade(PlayerThrowGrenadeEvent ev)
        {
            ...
            plugin.SendMessageToBot(Config.GetArray("channels.onthrowgrenade"), "player.onthrowgrenade", variables);
        }
        ...
        public void OnPlayerInfected(PlayerInfectedEvent ev)
        {
            ...
            plugin.SendMessageToBot(Config.GetArray("channels.onplayerinfected"), "player.onplayerinfected", variables);
        }
        ...
        public void OnSpawnRagdoll(PlayerSpawnRagdollEvent ev)
        {
            ...
            plugin.SendMessageToBot(Config.GetArray("channels.onspawnragdoll"), "player.onspawnragdoll", variables);
        }
        ...
        public void OnLure(PlayerLureEvent ev)
        {
            ...
            plugin.SendMessageToBot(Config.GetArray("channels.onlure"), "player.onlure", variables);
        }
        ...
        public void OnContain106(PlayerContain106Event ev)
        {
            ...
            plugin.SendMessageToBot(Config.GetArray("channels.oncontain106"), "player.oncontain106", variables);
        }
        ...
        public void OnMedkitUse(PlayerMedkitUseEvent ev)
        {
            ...
            plugin.SendMessageToBot(Config.GetArray("channels.onmedkituse"), "player.onmedkituse", variables);
        }
        ...
        public void OnShoot(PlayerShootEvent ev)
        {
            ...
            if(ev.Target == null)
            {
                ...
                plugin.SendMessageToBot(Config.GetArray("channels.onshoot"), "player.onshoot.notarget", noTargetVars);
                return;
            }
            ...
            {
                plugin.SendMessageToBot(Config.GetArray("channels.onshoot"), "player.onshoot.friendlyfire", variables);
            }

            plugin.SendMessageToBot(Config.GetArray("channels.onshoot"), "player.onshoot", variables);
        }
        ...
        public void On106CreatePortal(Player106CreatePortalEvent ev)
        {
            ...
            plugin.SendMessageToBot(Config.GetArray("channels.on106createportal"), "player.on106createportal", variables);
        }
        ...
        public void On106Teleport(Player106TeleportEvent ev)
        {
            ...
            plugin.SendMessageToBot(Config.GetArray("channels.on106teleport"), "player.on106teleport", variables);
        }
        ...
        public void OnElevatorUse(PlayerElevatorUseEvent ev)
        {
            ...
            plugin.SendMessageToBot(Config.GetArray("channels.onelevatoruse"), "player.onelevatoruse", variables);
        }
        ...
        public void OnHandcuffed(PlayerHandcuffedEvent ev)
        {
            ...
            if (ev.Owner != null)
            {
                ...
                plugin.SendMessageToBot(Config.GetArray("channels.onhandcuff"), "player.onhandcuff", variables);
            }
            else
            {
                Dictionary<string, string> variables = new Dictionary<string, string>
                ...
                plugin.SendMessageToBot(Config.GetArray("channels.onhandcuff"), "player.onhandcuff.nootherplayer", variables);
            }
        }
        ...
        public void OnPlayerTriggerTesla(PlayerTriggerTeslaEvent ev)
        {
            ...
            if(ev.Triggerable)
            {
                plugin.SendMessageToBot(Config.GetArray("channels.onplayertriggertesla"), "player.onplayertriggertesla", variables);
            }
            else
            {
                plugin.SendMessageToBot(Config.GetArray("channels.onplayertriggertesla"), "player.onplayertriggertesla.ignored", variables);
            }
        }
        ...
        public void OnSCP914ChangeKnob(PlayerSCP914ChangeKnobEvent ev)
        {
            ...
            plugin.SendMessageToBot(Config.GetArray("channels.onscp914changeknob"), "player.onscp914changeknob", variables);
        }
    }
}
