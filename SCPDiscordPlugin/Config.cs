...
namespace SCPDiscord
{
    public static class Config
    {
        ...
        private static Dictionary<string, string[]> configArrays = new Dictionary<string, string[]>
        {
            ...
            { "channels.oncheckescape",             new string[]{ } },
            { "channels.onspawn",                   new string[]{ } },
            { "channels.ondooraccess",              new string[]{ } },
            ...
            { "channels.onteamrespawn",             new string[]{ } },
