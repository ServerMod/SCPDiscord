...
namespace SCPDiscord
{
        ...
        IEventHandlerThrowGrenade
    {
        ...
        public void OnDoorAccess(PlayerDoorAccessEvent ev)
        {
            ...
            if (ev.Allow)
            {
                plugin.SendMessageAsync(ev.Player.Name + " (" + ev.Player.SteamId + ") opened a door.");
            }
            else
            {
                plugin.SendMessageAsync(ev.Player.Name + " (" + ev.Player.SteamId + ") tried to access a locked door.");
            }
        }
        ...
        public void OnIntercomCooldownCheck(PlayerIntercomCooldownCheckEvent ev)
        {
            ...
            /// <summary>  
            plugin.SendMessageAsync(ev.Player.Name + " (" + ev.Player.SteamId + ") is trying to use the intercom.");
        }
        ...
        public void OnPocketDimensionExit(PlayerPocketDimensionExitEvent ev)
        {
            ...
            /// <summary>  
            plugin.SendMessageAsync(ev.Player.Name + " (" + ev.Player.SteamId + ") escaped the pocket dimension.");
        }
        ...
        public void OnPocketDimensionEnter(PlayerPocketDimensionEnterEvent ev)
        {
            ...
            /// <summary>  
            plugin.SendMessageAsync(ev.Player.Name + " (" + ev.Player.SteamId + ") was taken into the pocket dimension.");
        }
        ...
        public void OnPocketDimensionDie(PlayerPocketDimensionDieEvent ev)
        {
            ...
            /// <summary>  
            plugin.SendMessageAsync(ev.Player.Name + " (" + ev.Player.SteamId + ") was lost in the pocket dimension.");
        }
